...
def point_to_iraq(point):
    ...
    path = os.path.join(a, 'iraq_admin_level_4.geojson')
...
def point_to_iran(point):
    ...
    a = os.path.abspath(os.path.join(os.path.dirname( __file__ ), '..', 'data'))
    path = os.path.join(a, 'iran_admin_level_4.geojson')
...
def point_to_brazil(point):
    ...
    a = os.path.abspath(os.path.join(os.path.dirname( __file__ ), '..', 'data'))
    path = os.path.join(a, 'brazil_admin_level_4.geojson')
